...
class ManualGitHubPagesDeployer {
  constructor() {
...
module.exports = nextConfig`;
  ...
  async deploy() {
    ...
    try {
      this.log(`开始手动部署到GitHub Pages (仓库: ${this.repoName})`, 'info');
...
// 运行部署
const deployer = new ManualGitHubPagesDeployer();
deployer.deploy();
